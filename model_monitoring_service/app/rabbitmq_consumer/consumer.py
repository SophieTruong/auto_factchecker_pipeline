...
class MonitoringConsumer:
    ...
    async def process_message(self, message: AbstractIncomingMessage):
        ...
        async with message.process():
            ...
            if not parsed_message or not self.monitoring_service.validate_message(parsed_message):
            ...
            if handler:
                ...
                print(f"Message processing {'succeeded' if success else 'failed'}: {event_type}.{module_name}")
